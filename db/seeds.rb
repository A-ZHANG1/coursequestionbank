...
@user00 = Instructor.create!(username: "saas", uid: "saas", name: "SaaS Instructor", provider: "developer", type: "Instructor")
# Whitelist.create!(username: @user00.username, provider: "developer", privilege: "instructor")
@user01 = Instructor.create!(username: "saas-admin", uid: "saas-admin", name: "Admin", provider: "developer", type: "Admin")
